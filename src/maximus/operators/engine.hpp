...
enum class EngineType : uint8_t { UNDEFINED, ACERO, CUDF, NATIVE };
...
public:
    ...
    bool on_gpu() const { return type == EngineType::CUDF; }

    bool on_cpu() const { return type == EngineType::ACERO || type == EngineType::NATIVE; }
